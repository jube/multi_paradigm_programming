...
\begin{frame}{\CCLang History (3/3)}{Modern \CCLang}
  \begin{block}{Modern \CCLang (2011--)}
    ...
    \item
      2020: \CC{20}, major revision (modules, concepts, coroutine)
    \item
      2023: \CC{23}, minor revision
    \item
      2026: \CC{26}, next major revision
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}{Object-oriented programming}{}
  \begin{definition}[Object-oriented programming]
    \strong{Object-oriented programming} is an imperative programming paradigm based on the concepts of \emph{objects} (data) and \emph{methods} (code).
  \end{definition}

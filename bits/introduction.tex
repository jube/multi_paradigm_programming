...
\begin{frame}{The \CCLang language}{}
  \begin{block}{What's in this section?}
    Any interesting aspects that are not specific to a programming paradigm
  \end{block}

  \begin{block}{What's \strong{not} in this section?}
    Basic programming constructs that are present in other programming languages
    \begin{itemize}
    \item
      Control flow statements: \lstinline!if!,  \lstinline!for!,  \lstinline!while!,  \lstinline!switch!, \ldots
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}{Properties of glvalues and rvalues}{}
  ...
  \begin{block}{Properties of a rvalue expression (prvalue or xvalue)}
    ...
    \item
      May be used to initialize a const lvalue reference
    \item
      May be used to initialize an rvalue reference
    \end{itemize}
  \end{block}
\end{frame}

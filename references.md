# References for Multi-Paradigm Programming
...
- [C++17 final working draft](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/n4659.pdf)
...
- [Getting started with C++](https://riptutorial.com/cplusplus)
...
- [Evolving a language in and for the real world: 1991-2006 - Bjarne Stroutrup](http://www.stroustrup.com/hopl-almost-final.pdf)
- [Basic concepts - cppreference.com](https://en.cppreference.com/w/cpp/language/basic_concepts)
...
- [Range-based for loop - cppreference.com](https://en.cppreference.com/w/cpp/language/range-for)

## Part 2: Procedural Programming

- [Default arguments - cppreference.com](https://en.cppreference.com/w/cpp/language/default_arguments)
...
- [Parameter passing - C++ Core Guidelines](https://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines#fcall-parameter-passing)
...
- [Copy constructor - cppreference.com](https://en.cppreference.com/w/cpp/language/copy_constructor)
...
- [Derived class - cppreference.com](https://en.cppreference.com/w/cpp/language/derived_class)
- [Empty base optimization - cppreference.com](https://en.cppreference.com/w/cpp/language/ebo)
...
- [D-Pointer - Qt](https://wiki.qt.io/D-Pointer)
- [The pImpl Idiom - Arne Mertz](https://arne-mertz.de/2019/01/the-pimpl-idiom/)
...
- [Callable - cppreference.com](https://en.cppreference.com/w/cpp/named_req/Callable)
- [https://en.cppreference.com/w/cpp/language/operator_member_access - cppreference.com](https://en.cppreference.com/w/cpp/language/operator_member_access)
- [Pointers to members - cppreference.com](https://en.cppreference.com/w/cpp/language/pointer#Pointers_to_members)
...
- [Currying and partial application in C++14 - BlackMat MATov](https://medium.com/@blackmatov/currying-and-partial-application-in-c-14-cc7c342accab)
...
- [auto specifier - cppreference.com](https://en.cppreference.com/w/cpp/language/auto)
- [decltype specifier - cppreference.com](https://en.cppreference.com/w/cpp/language/decltype)
- [AAA Style (Almost Always Auto) - Herb Sutter](https://herbsutter.com/2013/08/12/gotw-94-solution-aaa-style-almost-always-auto/)
- [Template metaprogramming - Wikipedia](https://en.wikipedia.org/wiki/Template_metaprogramming)
- [Constexpr If - cppreference.com](https://en.cppreference.com/w/cpp/language/if#Constexpr_If)
- [Generic Programming Techniques - Boost](https://www.boost.org/community/generic_programming.html)
- [Curiously recurring template pattern - Wikipedia](https://en.wikipedia.org/wiki/Curiously_recurring_template_pattern)
- [Policy-based design - Wikipedia](https://en.wikipedia.org/wiki/Modern_C%2B%2B_Design#Policy-based_design)
